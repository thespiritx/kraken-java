 ...
 * @since 1.0.0
 */
public class DirectUploadSetRequest extends AbstractUploadSetRequest {

    @JsonIgnore
    private final InputStream image;

    private DirectUploadSetRequest(Boolean dev,
                                Boolean webp,
                                Boolean lossy,
                                Integer quality,
    ...
    public static class Builder extends AbstractUploadSetRequest.Builder<Builder> {
        ...
        public DirectUploadSetRequest build() {
            return new DirectUploadSetRequest(
                    dev,
                    webp,
                    lossy,
                    quality,
