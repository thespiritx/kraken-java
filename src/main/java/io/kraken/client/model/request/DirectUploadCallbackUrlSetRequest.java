 ...
 * @since 1.0.0
 */
public class DirectUploadCallbackUrlSetRequest extends AbstractUploadCallbackUrlSetRequest {

    @JsonIgnore
    private final InputStream image;

    private DirectUploadCallbackUrlSetRequest(Boolean dev,
                                           Boolean webp,
                                           Boolean lossy,
                                           Integer quality,
    ...
    public static class Builder extends AbstractUploadCallbackUrlSetRequest.Builder<Builder> {
        ...
        public DirectUploadCallbackUrlSetRequest build() {
            return new DirectUploadCallbackUrlSetRequest(
                    dev,
                    webp,
                    lossy,
                    quality,
